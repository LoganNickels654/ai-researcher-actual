...
class ResearchAssistant:
    ...
    async def _rank_papers_by_relevance(self, original_question: str, papers: List[Paper]) -> List[Paper]:
        ...
        2. A explanation as to why it's relevant or not relevant, and how it can be used in research, be sure to highlight key points as to why this article would be beneficial for the user
        ...
        [
          {{
            "index": 0,
            "relevance_score": 8.5,
            "reason": "Directly addresses the research question with recent data, one of the most useful pages regarding the topic. Could provide meaningful insights into..."
          }},
          {{
            "index": 1,
            "relevance_score": 6.0,
            "reason": "Related topic but focuses on different population, could potentially provide insight into new avenues on topics such as..."
          }}
        ]
